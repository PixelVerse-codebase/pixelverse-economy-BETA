...
Config.Products = {
    ...
    ["Mining Store"] = {
        { name = 'water_bottle',       price = 5000, amount = 50 },
        { name = 'sandwich',       price = 5000, amount = 50 },
        { name = 'mininglaser',       price = 5000, amount = 50 },
        { name = 'drillbit',       price = 100, amount = 50 },
        { name = 'goldpan',       price = 100, amount = 50 },
    }
}
...
Config.Locations = {
    ...
    ["miningshop"] = {
        ["label"] = "Mining Store",
        ["type"] = "weapon",
        ["coords"] = vector4(2959.96, 2754.0, 43.71, 204.77),
        ["ped"] = 'ig_hunter',
        ["scenario"] = "WORLD_HUMAN_COP_IDLES",
        ["radius"] = 1.5,
        ["targetIcon"] = "fas fa-gun",
        ["targetLabel"] = "Open Mining Store",
        ["products"] = Config.Products["Mining Store"],
        ["showblip"] = true,
        ["blipsprite"] = 626,
        ["blipcolor"] = 1
    },
    ["miningshop2"] = {
        ["label"] = "Mining Store",
        ["type"] = "weapon",
        ["coords"] = vector4(1075.69, -1991.23, 30.88, 280.41),
        ["ped"] = 'ig_hunter',
        ["scenario"] = "WORLD_HUMAN_COP_IDLES",
        ["radius"] = 1.5,
        ["targetIcon"] = "fas fa-gun",
